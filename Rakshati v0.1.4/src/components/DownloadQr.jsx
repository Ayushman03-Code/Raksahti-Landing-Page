...
import QRLogo from '@images/qrcode.png';
import latput from '@images/latput.png';
	...
	return (
		<div className="">
			<button
				...
				className="fixed bottom-8 right-8 border border-neutral-400 p-2 rounded-xl z-40 hover:shadow-xl"
			>
				...
				>
					<div className="px-10 py-14 w-8/12">
						<h1 className="font-semibold text-xl">
							Finish setting up your Rakshati app account for a smooth journey
							ahead.
						</h1>
